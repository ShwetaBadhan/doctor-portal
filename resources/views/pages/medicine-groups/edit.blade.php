    ...
    <div class="content">
        ...
        <div class="mb-4">
            <h6 class="fw-bold mb-0 d-flex align-items-center">
                ...
                <span class="text-primary">Edit Group</span>
            </h6>
        </div>
        ...
        <form action="{{ route('medicine-groups.update', $medicineGroup) }}" method="POST">
            @csrf
            @method('PUT')
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" 
                                       ...
                                       name="name" 
                                       value="{{ old('name', $medicineGroup->name) }}" 
                                       placeholder="e.g., CA BLOOD, AUTISM-1" 
                                       required 
                                       autofocus>
                                @error('name')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" 
                                       ...
                                       name="code" 
                                       value="{{ old('code', $medicineGroup->code) }}" 
                                       placeholder="e.g., GD-4, CKD">
                                @error('code')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror" 
                                          name="description" 
                                          rows="3" 
                                          placeholder="Enter group description...">{{ old('description', $medicineGroup->description) }}</textarea>
                                @error('description')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-check form-switch">
                                    <input class="form-check-input" 
                                           ...
                                           name="is_active" 
                                           id="is_active" 
                                           {{ old('is_active', $medicineGroup->is_active) ? 'checked' : '' }}>
