                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 text-md-end">
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <input type="text" class="form-control form-control-sm" value="{{ $nextNumber }}" disabled>
                                    </div>
                                    <div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="patient_name" id="patientName" class="form-control" value="{{ old('patient_name') }}" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label fw-medium">Mobile</label>
                                        <input type="text" name="patient_mobile" id="patientMobile" class="form-control" value="{{ old('patient_mobile') }}">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="mb-3">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <textarea name="terms" class="form-control" rows="3" placeholder="All disputes subject to Jalandhar jurisdiction. Goods once sold will not be taken back.">{{ old('terms', 'All Disputes are Subject to Jalandhar jurisdiction Only. Goods Once Sold will not taken back or exchanged.') }}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
