                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="recipient_pincode" class="form-control" 
                                               value="{{ old('recipient_pincode', $shipment->recipient_pincode) }}" required>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="courier_name" class="select">
                                    ...
                                    <option value="Blue Dart" {{ old('courier_name', $shipment->courier_name) == 'Blue Dart' ? 'selected' : '' }}>Blue Dart</option>
                                    <option value="DTDC" {{ old('courier_name', $shipment->courier_name) == 'DTDC' ? 'selected' : '' }}>DTDC</option>
                                    <option value="Delhivery" {{ old('courier_name', $shipment->courier_name) == 'Delhivery' ? 'selected' : '' }}>Delhivery</option>
                                    <option value="India Post" {{ old('courier_name', $shipment->courier_name) == 'India Post' ? 'selected' : '' }}>India Post</option>
                                    <option value="Other" {{ old('courier_name', $shipment->courier_name) == 'Other' ? 'selected' : '' }}>Other</option>
                                </select>
                            </div>
