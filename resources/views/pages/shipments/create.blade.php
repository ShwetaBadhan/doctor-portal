                                ...
                                <div class="row">
                                            ...
                                            <select name="invoice_id" class="select">
                                                ...
                                                @foreach ($invoices as $inv)
                                                    <option value="{{ $inv->id }}">{{ $inv->invoice_number }} -
                                                        {{ $inv->patient_name }} (₹{{ $inv->total_amount }})</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select name="patient_id" class="select" id="patientSelect"
                                                onchange="fillPatientAddress()">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <!-- Inside the recipient details row, after Pincode -->
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <small class="text-muted">e.g., India, USA, UK</small>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="mb-3">
