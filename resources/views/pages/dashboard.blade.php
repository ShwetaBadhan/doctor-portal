                                    ...
                                    <div class="col-md-4">
                                        <div class="border shadow-sm p-3 rounded-2">
                                            <div class="d-flex align-items-center mb-3">
                                                <a href="{{ route('doctor-details') }}" class="avatar me-2 flex-shrink-0 position-relative">
                                                ...
                                                <div>
                                                  <h6 class="fs-14 mb-1 text-truncate"><a href="{{ route('doctor-details') }}" class="fw-semibold">Dr. Alex Morgan</a></h6>
                                    ...
                                    <div class="col-md-4">
                                        <div class="border shadow-sm p-3 rounded-2">
                                            <div class="d-flex align-items-center mb-3">
                                                ...
                                                <div>
                                                  <h6 class="fs-14 mb-1 text-truncate"><a href="{{ route('doctor-details') }}" class="fw-semibold">Dr. Emily Carter</a></h6>
                                    ...
                                    <div class="col-md-4">
                                        <div class="border shadow-sm p-3 rounded-2">
                                            <div class="d-flex align-items-center mb-3">
                                                ...
                                                <div>
                                                  <h6 class="fs-14 mb-1 text-truncate"><a href="{{ route('doctor-details') }}" class="fw-semibold">Dr. David Lee</a></h6>
                    ...
                    <div class="col-xl-4">
                        <div class="card shadow-sm">
                            ...
                            <div class="card-body">
                                ...
                                <a href="{{ route('appointments.create') }}" class="btn btn-light w-100">View All Appointments</a>
                            </div>
                        </div>
                    </div>
                     <!-- col end -->
                              ...
                              <div class="overflow-auto">
                                  <div class="d-flex justify-content-between align-items-center mb-3">
                                      <div class="d-flex align-items-center flex-shrink-0">
                                          <a href="{{ route('doctor-details') }}" class="avatar flex-shrink-0">
                                              <img src="assets/img/doctors/doctor-02.jpg" class="rounded-circle" alt="img">
                                          </a>
                                          <div class="ms-2 flex-shrink-0">
                                              <div>
                                                  <h6 class="fw-semibold fs-14 text-truncate mb-1"><a href="{{ route('doctor-details') }}">Dr. Sarah Johnson</a></h6>
                                  ...
                                  <div class="d-flex justify-content-between align-items-center mb-3">
                                      <div class="d-flex align-items-center flex-shrink-0">
                                          ...
                                          <div class="ms-2 flex-shrink-0">
                                              <div>
                                                  <h6 class="fw-semibold fs-14 text-truncate mb-1"><a href="{{ route('doctor-details') }}">Dr. Emily Carter</a></h6>
                                  ...
                                  <div class="d-flex justify-content-between align-items-center mb-3">
                                      <div class="d-flex align-items-center flex-shrink-0">
                                          ...
                                          <div class="ms-2 flex-shrink-0">
                                              <div>
                                                  <h6 class="fw-semibold fs-14 text-truncate mb-1"><a href="{{ route('doctor-details') }}">Dr. David Lee</a></h6>
                                  ...
                                  <div class="d-flex justify-content-between align-items-center mb-0">
                                      <div class="d-flex align-items-center flex-shrink-0">
                                          ...
                                          <div class="ms-2 flex-shrink-0">
                                              <div>
                                                  <h6 class="fw-semibold fs-14 text-truncate mb-1"><a href="{{ route('doctor-details') }}">Dr. Michael Smith</a></h6>
                    ...
                    <div class="col-12 d-flex">
                        <div class="card shadow-sm flex-fill w-100">
                            <div class="card-header d-flex align-items-center justify-content-between">
                                ...
                                <a href="{{ route('appointments.create') }}" class="btn fw-normal btn-outline-white">View All</a>
                            </div>
                            <div class="card-body">
                                <!-- Table start -->
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <a href="{{ route('doctor-details') }}" class="avatar me-2">
                                                            <img src="assets/img/doctors/doctor-06.jpg" alt="img" class="rounded-circle">
                                                        </a>
                                                        <div>
                                                          <h6 class="fs-14 mb-1"><a href="{{ route('doctor-details') }}" class="fw-semibold">Dr. John Smith</a></h6>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                          <h6 class="fs-14 mb-1"><a href="" class="fw-medium">Jesus Adams</a></h6>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                          <h6 class="fs-14 mb-1"><a href="{{ route('doctor-details') }}" class="fw-semibold">Dr. Lisa White</a></h6>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                          <h6 class="fs-14 mb-1"><a href="" class="fw-medium">Ezra Belcher</a></h6>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                          <h6 class="fs-14 mb-1"><a href="{{ route('doctor-details') }}" class="fw-semibold">Dr. Patricia Brown</a></h6>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                          <h6 class="fs-14 mb-1"><a href="" class="fw-medium">Glen Lentz</a></h6>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                          <h6 class="fs-14 mb-1"><a href="{{ route('doctor-details') }}" class="fw-semibold">Dr. Rachel Green</a></h6>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                          <h6 class="fs-14 mb-1"><a href="" class="fw-medium">Bernard Griffith</a></h6>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                          <h6 class="fs-14 mb-1"><a href="{{ route('doctor-details') }}" class="fw-semibold">Dr. Michael Smith</a></h6>
                                                          <p class="mb-0 fs-13">Cardiologist</p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                          <h6 class="fs-14 mb-1"><a href="" class="fw-medium">John Elsass</a></h6>
                    ...
                    <div class="col-xl-4 d-flex">
                        <div class="card shadow-sm flex-fill w-100">
                            <div class="card-header d-flex align-items-center justify-content-between">
                                ...
                                <a href="{{ route( 'patients.index') }}" class="btn fw-normal btn-outline-white">View All</a>
                            </div>
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                          <h6 class="fs-14 mb-1 text-truncate"><a href="" class="fw-medium">Jesus Adams</a></h6>
                                ...
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                          <h6 class="fs-14 mb-1 text-truncate"><a href="" class="fw-medium">Ezra Belcher</a></h6>
                                ...
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                          <h6 class="fs-14 mb-1 text-truncate"><a href="" class="fw-medium">Glen Lentz</a></h6>
                                ...
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                          <h6 class="fs-14 mb-1 text-truncate"><a href="" class="fw-medium">Bernard Griffith</a></h6>
                                ...
                                <div class="d-flex justify-content-between align-items-center mb-0">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                          <h6 class="fs-14 mb-1 text-truncate"><a href="" class="fw-medium">John Elsass</a></h6>
                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-between mb-3">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-2">
                                            <div>
                                                <h6 class="fw-semibold text-truncate mb-1 fs-14"><a href="{{ route('doctor-details') }}">James Allaire</a></h6>
                                ...
                                <div class="d-flex justify-content-between mb-3">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-2">
                                            <div>
                                                <h6 class="fw-semibold text-truncate mb-1 fs-14"><a href="{{ route('doctor-details') }}">Esther Schmidt</a></h6>
                                ...
                                <div class="d-flex justify-content-between mb-3">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-2">
                                            <div>
                                                <h6 class="fw-semibold text-truncate mb-1 fs-14"><a href="{{ route('doctor-details') }}">Valerie Padgett</a></h6>
                                ...
                                <div class="d-flex justify-content-between mb-3">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-2">
                                            <div>
                                                <h6 class="fw-semibold text-truncate mb-1 fs-14"><a href="{{ route('doctor-details') }}">Diane Nash</a></h6>
                                ...
                                <div class="d-flex justify-content-between mb-0">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-2">
                                            <div>
                                                <h6 class="fw-semibold text-truncate mb-1 fs-14"><a href="{{ route('doctor-details') }}">Sally Cavazos</a></h6>
