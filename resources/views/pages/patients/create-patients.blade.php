                            ...
                            <div class="card-body py-3">
                                <div class="progress-steps d-flex justify-content-between position-relative">
                                    ...
                                    @foreach ($steps as $num => $step)
                                        <div class="step-item text-center {{ $num == 1 ? 'active' : '' }}"
                                            data-step="{{ $num }}">
                                            <div
                                                class="step-icon rounded-circle bg-light text-primary d-inline-flex align-items-center justify-content-center">
                                                <i class="{{ $step['icon'] }}"></i>
                                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select class="select @error('blood_group') is-invalid @enderror"
                                                name="blood_group">
                                                        ...
                                                        @foreach ($symptoms as $symptom)
                                                            <div class="form-check mb-1">
                                                                <input class="form-check-input symptom-checkbox"
                                                                    type="checkbox" name="existing_symptoms[]"
                                                                    value="{{ $symptom }}"
                                                ...
                                                @foreach ($symptomsByCategory as $category => $symptoms)
                                                    <div class="mb-3">
                                                        ...
                                                        @foreach ($symptoms as $symptom)
                                                            <div class="form-check mb-1">
                                                                <input class="form-check-input symptom-checkbox"
                                                                    type="checkbox" name="non_existing_symptoms[]"
                                                                    value="{{ $symptom }}"
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="cp"
                                                        value="yes" {{ old('cp') == 'yes' ? 'checked' : '' }}
                                                        id="cp_yes">
                                                    <label class="form-check-label" for="cp_yes">YES</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="cp"
                                                        value="no" {{ old('cp') == 'no' ? 'checked' : '' }}
                                                        id="cp_no">
                                                ...
                                                <div class="mt-3">
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox"
                                                            ...
                                                            {{ in_array('upper_limb', old('cp_movement', [])) ? 'checked' : '' }}
                                                            id="cp_upper">
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox"
                                                            ...
                                                            {{ in_array('lower_limb', old('cp_movement', [])) ? 'checked' : '' }}
                                                            id="cp_lower">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" name="therapy_history" rows="2"
                                                placeholder="Please Enter the History of the Patient">{{ old('therapy_history') }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="file"
                                                ...
                                                name="test_reports[]" multiple accept=".pdf,.jpg,.jpeg,.png,.doc,.docx"
                                                id="testReportsInput">
