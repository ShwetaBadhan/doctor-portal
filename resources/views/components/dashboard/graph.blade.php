        ...
        <div class="card-header d-flex align-items-center justify-content-between">
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="{{ route('dashboard', ['period' => 'monthly']) }}">Monthly</a>
                    </li>
            ...
            <div class="row row-gap-3 mb-3">
                <div class="col-md-3 col-sm-6">
                    <div class="bg-light border p-2 text-center rounded-2">
                        <p class="mb-1 text-body text-truncate"><i class="ti ti-point-filled me-1 text-primary"></i>All
                            Appointments</p>
                ...
                <div class="mb-3 bg-light p-3 rounded-2 d-flex align-items-center justify-content-between">
                    <div>
                        ...
                        <h6 class="fs-14 fw-semibold mb-1">
                            {{ $app->patient?->first_name ?? 'Unknown' }} {{ $app->patient?->last_name ?? 'Patient' }}
                        </h6>
                        <p class="mb-0 text-body text-truncate">
                            <i class="ti ti-calendar-time me-1 text-body"></i>
                            {{ \Carbon\Carbon::parse($app->appointment_date)->format('D, d M Y') }}
                        </p>
                    </div>
