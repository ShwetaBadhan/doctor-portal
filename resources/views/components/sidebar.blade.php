                                ...
                                <ul style="display: {{ $appointmentsActive ? 'block' : 'none' }};">
                                    ...
                                    <li>
                                        <a href="{{ route('appointments.today') }}"
                                            class="{{ request()->routeIs('appointments.today') ? 'active' : '' }}">
                                ...
                                <ul style="display: {{ $medicinesActive ? 'block' : 'none' }};">
                                    <li>
                                        <a href="{{ route('medicine-groups.index') }}"
                                            class="{{ request()->routeIs('medicine-groups.index') ? 'active' : '' }}">
                                            Medicine Groups
                                        </a>
                                    </li>
                                    @can('create-medicine-groups')
                                        <li>
                                            <a href="{{ route('medicine-groups.create') }}"
                                                class="{{ request()->routeIs('medicine-groups.create') ? 'active' : '' }}">
                                                Add New Group
                                            </a>
                                        </li>
                                    @endcan
                                ...
                                <ul style="display: {{ $invoicesActive ? 'block' : 'none' }};">
                                    <li>
                                        <a href="{{ route('invoices.index') }}"
                                            class="{{ request()->routeIs('invoices.index') ? 'active' : '' }}">
                                            All Invoices
                                        </a>
                                    </li>
                                    @can('create-invoices')
                                        <li>
                                            <a href="{{ route('invoices.create') }}"
                                                class="{{ request()->routeIs('invoices.create') ? 'active' : '' }}">
                                                Create Invoice
                                            </a>
                                        </li>
                                    @endcan
                                ...
                                <ul style="display: {{ $shipmentsActive ? 'block' : 'none' }};">
                                    <li>
                                        <a href="{{ route('shipments.index') }}"
                                            class="{{ request()->routeIs('shipments.index') ? 'active' : '' }}">
                                            Shipments List
                                        </a>
                                    </li>
                                    @can('create-shipments')
                                        <li>
                                            <a href="{{ route('shipments.create') }}"
                                                class="{{ request()->routeIs('shipments.create') ? 'active' : '' }}">
                                                Create
                                            </a>
                                        </li>
                                    @endcan
